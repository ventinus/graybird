  ...
  describe 'PUT #update' do
    ...
    context 'with valid attributes' do
      it 'updates the administrator' do
        process :update, method: :put, params: { id: @administrator, administrator: attributes_for(:administrator, first_name: 'Joaquin') }

        @administrator.reload
        expect(assigns(:administrator).first_name).to eq('Joaquin')
      end

      it 'redirects to the index view' do
        process :update, method: :put, params: { id: @administrator, administrator: attributes_for(:administrator, first_name: 'Joaquin', current_password: 'password') }
  ...
  describe 'DELETE #destroy' do
    ...
    context 'with invalid attributes' do
      it 'does not delete the administrator' do
        # binding.pry
        expect { process :destroy, method: :delete, params: { id: @admin } }.to_not change(Administrator, :count)
      end
